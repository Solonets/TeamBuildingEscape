...
public class Main {
    ...
    public static void createGame() {
        ...
        eventList.add(new SleepEvent("Сон", 192, Event.EventType.STARTED));
        eventList.add(new SleepEvent("Сон", 288, Event.EventType.FINISHED));

        Event eventBreakfastStarts = new EatEvent("Зaвтрак", 0 + 288, Event.EventType.STARTED);
        eventList.add(eventBreakfastStarts);
        Event eventTeambuildingStarts1 = new TeambuildingEvent("Тимбилдинг", 12  + 288, Event.EventType.STARTED);
        eventList.add(eventTeambuildingStarts1);
        Event eventBreakfastFinished = new EatEvent("Зaвтрак", 24  + 288, Event.EventType.FINISHED);
        eventList.add(eventBreakfastFinished);
        Event eventMessageRecieved1 = new PhoneMessageEvent("Телефон", 36  + 288, Event.EventType.STARTED, "Лена: собираемся в 108, будет организационное собрание");
        eventList.add(eventMessageRecieved1);
        Event eventTeambuildingStartsFinished1 = new TeambuildingEvent("Тимбилдинг", 60  + 288, Event.EventType.FINISHED);
        eventList.add(eventTeambuildingStartsFinished1);
        Event eventLunchStarts = new EatEvent("Обед", 72  + 288, Event.EventType.STARTED);
        eventList.add(eventLunchStarts);
        Event eventMessageRecieved2 = new PhoneMessageEvent("Телефон", 84  + 288, Event.EventType.STARTED, "Лена: собираемся в читальном зале, будет организационное собрание");
        eventList.add(eventMessageRecieved2);
        Event eventTeambuildingStarts2 = new TeambuildingEvent("Тимбилдинг", 84  + 288, Event.EventType.STARTED);
        eventList.add(eventTeambuildingStarts2);
        Event eventLunchFinished = new EatEvent("Обед", 96  + 288, Event.EventType.FINISHED);
        eventList.add(eventLunchFinished);
        Event eventDinnerStarts = new EatEvent("Ужин", 132  + 288, Event.EventType.STARTED);
        eventList.add(eventDinnerStarts);
        Event eventTeambuildingStartsFinished2 = new TeambuildingEvent("Тимбилдинг", 144 + 288, Event.EventType.FINISHED);
        eventList.add(eventTeambuildingStartsFinished2);
        Event eventMessageRecieved3 = new PhoneMessageEvent("Телефон", 144 + 288, Event.EventType.STARTED, "Лена: собираемся в 211, будет организационное собрание");
        eventList.add(eventMessageRecieved3);
        Event eventDinnerFinished = new EatEvent("Ужин", 156 + 288, Event.EventType.FINISHED);
        eventList.add(eventDinnerFinished);
        Event eventMessageRecieved4 = new PhoneMessageEvent("Телефон", 170 + 288, Event.EventType.STARTED, "Лена: собираемся в 310, будет организационное собрание");
        eventList.add(eventMessageRecieved4);
